...
"""Services base that injects the Keycloak bearer token into every SIP gRPC call.

The generated service wrappers (``ondewo/sip/client/services/*.py``) subclass
:class:`ServicesInterface` and forward :attr:`ServicesInterface.metadata` to every stub
call. When the :class:`~ondewo.sip.client.client_config.ClientConfig` opts into the D18
